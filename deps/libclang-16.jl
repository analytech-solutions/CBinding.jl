begin
    ...
    begin
        ...
        (CBinding.CBinding).bitstype(::CBinding.Type{var"(c\"CXGlobalOptFlags\")"}; var"#92#kwargs"...) = begin
                var"(c\"CXGlobalOptFlags\")"
            end
        (CBinding.CBinding).bitstype(::CBinding.Type{var"c\"CXGlobalOptFlags\""}; var"#94#kwargs"...) = begin
                var"(c\"CXGlobalOptFlags\")"
            end
        ...
        const var"c\"CXCursor_LastStmt\"" = var"(c\"enum CXCursorKind\")"(0x0000000000000131)
