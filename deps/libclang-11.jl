begin
    ...
    begin
        ...
        begin
            const var"c\"clang_Type_getValueType\"" = CBinding.Cbinding{CBinding.Cfunction{var"c\"CXType\"", CBinding.Tuple{var"c\"CXType\""}, :cdecl}, libpath, :clang_Type_getValueType}()
            (func::CBinding.typeof(var"c\"clang_Type_getValueType\""))(var"c\"CT\"") = begin
                    CBinding.funccall(func, var"c\"CT\"")
                end
