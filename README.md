...
Read on to learn how to automatically create C library bindings, or [learn how to use the generated bindings](#using-cbindingjl-generated-bindings).
...
Therefore everything generated by CBinding.jl can be accessed with the `c"..."` string macro ([more about this below](#using-cbindingjl-generated-bindings)) to indicate that it lives in C-land.
...
[As detailed below](#any-gotchas), the `bitstype(T)` function can be used to acquire the concrete bits type of user-defined C types as well.
